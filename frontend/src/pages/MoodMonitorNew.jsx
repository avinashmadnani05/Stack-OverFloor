      ...
      <div className="container" style={{ padding: '3rem 1rem' }}>
          ...
          <div style={{ position: 'relative', zIndex: 2 }}>
            ...
            {currentMood && (
              <div style={{ marginTop: '3rem', textAlign: 'center' }}>
                <label style={{ fontSize: '1.2rem', fontWeight: '600', display: 'block', marginBottom: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', justifyContent: 'center' }}>
                  ...
                  <input
                    ...
                    style={{ 
                      ...
                      height: '8px', 
                      borderRadius: '5px',
                      background: `linear-gradient(to right, #ddd 0%, ${getCurrentMoodData()?.color || 'var(--primary-color)'} ${moodIntensity * 10}%, #ddd ${moodIntensity * 10}%)`
                    }}
                  />
                  ...
                  <div style={{ 
                    ...
                    fontWeight: 'bold',
                    fontSize: '1.5rem',
                    boxShadow: `0 4px 15px ${getCurrentMoodData()?.color || 'var(--primary-color)'}50`
                  }}>
                    {moodIntensity}
                  </div>
                </div>
            ...
            <div style={{ marginTop: '3rem' }}>
              <label style={{ textAlign: 'center', display: 'block', fontSize: '1.2rem', fontWeight: '600', marginBottom: '1.5rem' }}>
                ...
                {commonTriggers.map((trigger) => (
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: '500',
                      transition: 'all 0.3s ease',
                      boxShadow: triggers.includes(trigger) ? '0 4px 12px rgba(74, 144, 226, 0.3)' : 'none'
                    }}
                  >
                    {trigger}
                  </button>
            ...
            {/* Notes */}
            <div style={{ marginTop: '3rem' }}>
              <label style={{ fontSize: '1.2rem', fontWeight: '600', marginBottom: '1rem', display: 'block' }}>
            ...
            <div style={{ textAlign: 'center', marginTop: '3rem' }}>
              <button
                ...
                style={{ 
                  ...
                  color: 'white',
                  border: 'none',
                  cursor: currentMood ? 'pointer' : 'not-allowed',
                  display: 'flex',
                  alignItems: 'center',
                  gap: '0.5rem',
                  margin: '0 auto',
        ...
        {currentMood && (
          <div style={{ 
            ...
            <h3 style={{ marginBottom: '2rem', color: 'var(--text-primary)', textAlign: 'center', fontSize: '1.8rem' }}>
            ...
            <div style={{ display: 'grid', gap: '1rem' }}>
              {getCurrentTips().map((tip, index) => (
                ...
                >
                  <Lightbulb size={20} style={{ color: getCurrentMoodData()?.color, marginTop: '0.2rem' }} />
                  <p style={{ margin: 0, color: 'var(--text-primary)', fontSize: '1rem', lineHeight: '1.6' }}>{tip}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
            <h3 style={{ color: 'var(--text-primary)', margin: 0, fontSize: '1.8rem' }}>Recent Mood History</h3>
            <button style={{
              padding: '0.75rem 1.5rem',
              fontSize: '0.95rem',
            ...
            {moodHistory.map((entry, index) => (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div>
                    <div style={{ fontWeight: '600', color: 'var(--text-primary)', textTransform: 'capitalize', fontSize: '1.1rem' }}>
                      {entry.mood}
                    </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <TrendingUp size={20} style={{ color: entry.color }} />
                  <span style={{ fontWeight: '600', color: entry.color, fontSize: '1.1rem' }}>
                    {entry.intensity}/10
                  </span>
                </div>
              </div>
        ...
        <div style={{ 
          ...
          <h4 style={{ marginBottom: '1rem', color: 'var(--primary-color)', fontSize: '1.8rem', fontWeight: '600' }}>
            🧠 Mental Health Resources
          </h4>
          <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem', fontSize: '1.1rem', lineHeight: '1.6' }}>
            If you're struggling with your mental health, remember that help is available and seeking support is a sign of strength.
          </p>
